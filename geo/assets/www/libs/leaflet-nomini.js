    ...
    o.Mixin = {}, o.Mixin.Events = {
        ...
        latLngToPoint: function (t, e) {
            var i = this.projection.project(t),
                n = this.scale(e);
            console.log('XXXX: latLngToPoint: t: ' + t + ', e: ' + e + ', i: ' + i + ', n: ' + n);
        ...
        getSize: function () {
            console.log('XXXX: getSize');
            return (!this._size || this._sizeChanged) && (this._size = new o.Point(this._container.clientWidth, this._container.clientHeight), this._sizeChanged = !1, console.log('XXXX: getSize: this._size: ' + this._size)), this._size.clone()
        },
        getPixelBounds: function () {
            var t = this._getTopLeftPoint();
            console.log('XXXX: getPixelBounds: top left point: ' + t);
        ...
        _getNewTopLeftPoint: function (t, e) {
            console.log('XXXX: _getNewTopLeftPoint: t: ' + t + ', e: ' + e);
        ...
        _update: function () {
            if (this._map) {
                ...
                console.log('XXXX: _update: pixelBounds: ' + t + ', zoom: ' + e + ', tileSize: ' + i);
                if (!(e > this.options.maxZoom || e < this.options.minZoom)) {
                    console.log('XXXX: _update: bounds: ' + t.min.divideBy(i)._floor() + ':' + t.max.divideBy(i)._floor());
        ...
        _addTilesFromCenterOut: function (t) {
            console.log('XXXX: _addTilesFromCenterOut: ')
            var i, n, s, a = [],
                r = t.getCenter();
        ...
        _addTile: function (t, e) {
            ...
            console.log('XXXX: in _addTile, t: ' + t);
        ...
        _getTilePos: function (t) {
            var e = this._map.getPixelOrigin(),
                i = this.options.tileSize;
            console.log('XXXX: _getTilePos: pixel origin: ' + e + ', tile size: ' + i);
        ...
        _getTile: function () {
            if (this.options.reuseTiles && this._unusedTiles.length > 0) {
                ...
                console.log('XXXX: _getTile: in reuse branch, t: ' + t);
                return this._resetTile(t), t
            }
            console.log('XXXX: _getTile: NOT in reuse branch');
            return this._createTile()
        },
        _resetTile: function () {},
        _createTile: function () {
            var t = this._tileImg.cloneNode(!1);
            console.log('XXXX: _createTile: t: ' + t);
        ...
        _loadTile: function (t, e) {
            console.log('XXXX: parent _loadTile!!!');
